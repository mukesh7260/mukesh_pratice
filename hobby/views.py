...
class ItemAPIView(APIView):
    ...
    def get(self,request):
        ...
        if user_id:
            try:
                ...
                ads = Item.objects.filter(user=user)
                serializer = ItemSerializer(ads, many=True)
    ...
    def put(self,request,ad_id):
        ad = get_object_or_404(Item, id=ad_id)
        ...
        serializer=ItemSerializer(ad,data=request.data, partial=True)
        if serializer.is_valid():
            serializer.save()
